...
public class AppCCloud
{
    ...
    private static extern void _setupAppCWithMediaKey(string mk, int opt_ad, int opt_gamers, int opt_push, int opt_data, int opt_purchase);
    [DllImport("__Internal")]
    private static extern void _showAppCSimpleViewTop();
    [DllImport("__Internal")]
    private static extern void _showAppCSimpleViewBottom();
    [DllImport("__Internal")]
    private static extern void _hideAppCSimpleView();
    [DllImport("__Internal")]
    private static extern void _showAppCMarqueeViewTop();
    [DllImport("__Internal")]
    private static extern void _showAppCMarqueeViewBottom();
    [DllImport("__Internal")]
    private static extern void _showAppCMoveIconView(double horizontal, double vertical);
    [DllImport("__Internal")]
    private static extern void _hideAppCMoveIconView();
    [DllImport("__Internal")]
    private static extern void _hideAppCMarqueeView();
    [DllImport("__Internal")]
    private static extern void _showAppCWebView();
    [DllImport("__Internal")]
	...
	public class _Ad
	{
		...
		/// <summary>
		/// Hides all views.
		/// hide SimpleView and MarqueeView
		/// </summary>
	    ...
	    public void ShowSimpleView(Vertical vertical)
	    {
	        ...
	        {
	            case Vertical.Top:
	                _showAppCSimpleViewTop();
	                break;
	            case Vertical.Bottom:
	                _showAppCSimpleViewBottom();
	                break;
	            default:
					_showAppCSimpleViewTop();
	                break;
	    ...
	    public void ShowMarqueeView(Vertical vertical)
	    {
	        ...
	        {
	            case Vertical.Top:
	                _showAppCMarqueeViewTop();
	                break;
	            case Vertical.Bottom:
	                _showAppCMarqueeViewBottom();
	                break;
	            default:
					_showAppCMarqueeViewTop();
					break;
